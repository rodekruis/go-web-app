...
- `NrwMapPopupPanel` this replaces the Go map popup panel, since that component is an extended MapBox UI element, and can't be reused. This is the popup when an item on the map is clicked.
