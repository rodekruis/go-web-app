...
2. Set up this repo to run, following the readme in the base directory. Be sure to recopy `sample.env` into `.env` each time there were any changes in example.env.
